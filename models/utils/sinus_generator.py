...
parser.add_argument("--period", help="function period", default=5, required=False)
parser.add_argument("--amplitude", help="function amplitude", default=10, required=False)
