...
python main.py --config config_a2c --df_name generated_data/sinus_l0.4_M150_h10_noise0_nbsin1.csv --load 1 --save 1 --num_episode 10000 --save_path models_records/A2Csinus1 --load_path models_records/A2Csinus0  --lr 1
